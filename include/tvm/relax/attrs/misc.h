...
/*!
 * \file tvm/relax/attrs/misc.h
 * \brief Attributes for smooth operators.
 */
#ifndef TVM_RELAX_ATTRS_MISC_H_
#define TVM_RELAX_ATTRS_MISC_H_
...
/*! \brief Attributes for smooth operator */
struct AnnotateSmoothAttrs : public tvm::AttrsNode<AnnotateSmoothAttrs> {
  ...
  TVM_DECLARE_ATTRS(AnnotateSmoothAttrs, "relax.attrs.AnnotateSmoothAttrs") {
    ...
    TVM_ATTR_FIELD(mode).set_default("identity").describe("Execution mode for op. Can be: \"identity\" or \"multiply\"");
  }
